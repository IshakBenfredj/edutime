  ...
  return (
    <div className="conditions container">
      ...
      <pre className="gray-bg text-color text">
        ...
        قم بالنقر بعدها على زر “أضف دورة” بعدها إملئ جميع المعلومات الخاصة
        بدورتك. ثم قم بدفع حقوق الاشتراك وأرسل لنا وصل يثبت تسديد المستحقات
        بعدها ستتم مراجعتها من طرف فريقنا خلال مدة زمنية قصيرة. في حال لم تحتوي
        الخدمة على أي مخالفات سيتم قبولها وتظهر للمشتركين ويمكننا بعد ذلك البدأ
        بالترويج لها وجذب عملاء لك، وإن رُفضت سيتم إعلامك بسبب الرفض عبر بريدك
        الإلكتروني او عن طريق الاتصال بك هاتفيا. بعد اضافة دورتك في منصتنا وتلقي
        الطلبات (الحجوزات) في دوراتك سوف تتصليون بهم هاتفيا لتأكيد حجوزاتهم
        واستعلامهم بمزيد من المعلومات. <br />
        <span>
          🟢 إذا كنت من الراغبين في تطوير مهاراتك في مختلف المجالات (طالب):{" "}
        </span>
        أنشئ حساباً جديداً كطالب أو سجل الدخول للموقع إذا كان لديك حساب، ابحث عن
