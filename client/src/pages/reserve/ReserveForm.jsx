      ...
      <div className="center gap-3">
        <form className="gray-bg" onSubmit={reservation}>
          <input
            ...
            value={info.name}
            name="name"
            placeholder="الاسم واللقب بالعربية"
            className={`mb-3 ${emptyName ? "border-danger" : "border-0"}`}
          ...
          <input
            ...
            onBlur={handleBlur}
            value={info.birthday}
            className={`mb-3 ${emptyBirthday ? "border-danger" : "border-0"}`}
            onChange={handleChange}
          />
          <input
            type="text"
            value={info.wilaya}
            name="wilaya"
            placeholder="ولاية الإقامة"
            className={`mb-3 ${emptyWilaya ? "border-danger" : "border-0"}`}
            onChange={handleChange}
          />
          <input
            type="text"
            ...
            className={`mb-3 ${emptyPhone ? "border-danger" : "border-0"}`}
            onChange={handleChange}
          />
          <input
            type="text"
            ...
            className={`mb-3 ${emptyEmail ? "border-danger" : "border-0"}`}
            onChange={handleChange}
          />
